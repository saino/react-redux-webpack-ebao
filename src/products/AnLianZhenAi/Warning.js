...
export const Warning = ({open, onRequestClose}) => (
  <Modal title="违反如实告知页面" titleStyle={{backgroundColor: 'red'}} showCloseButton={true} open={open} onRequestClose={()=>onRequestClose && onRequestClose()}>
    <div>
      <p>发生理赔时，我们会对投保人填写的各项信息进行核实，如发现投保人违反了如实告知，根据《保险法》的规定，我们将不承担赔偿或给付保险金的责任。</p>
      <p style={{color: 'red'}}>《中华人民共和国保险法》第十六条：</p>
      ...
      <p style={{color: 'red'}}>《刑法》第一百九十八条：</p>
