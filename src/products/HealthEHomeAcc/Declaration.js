...
export const Declaration = ({open, onRequestClose}) => (
  <Modal title="投保声明" showCloseButton={true} open={open} onRequestClose={()=>onRequestClose && onRequestClose()}>
    <div>
      <p>1. 本人自愿投保贵公司团体住院医疗保险及附加团体门急诊医疗保险，并声明以上陈述及各项细节均真实无讹，且没有隐瞒任何重大事实以影响贵公司评估风险或接受本投保申请。</p>
      <p>2. 本人已认真阅读《安心财产保险有限责任公司团体住院医疗保险条款（2016版）》《安心财产保险有限责任公司附加团体门急诊医疗保险条款》的所有条款，尤其是“责任免除”并对贵公司就保险合同的内容说明和提示完全理解，没有异议，申请投保。</p>
